...
# invest_advisor/
APPS_DIR = ROOT_DIR / "invest_advisor"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "invest_advisor.contrib.sites.migrations"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Invest Advisor API",
    "DESCRIPTION": "Documentation of API endpoints of Invest Advisor",
    "VERSION": "1.0.0",
